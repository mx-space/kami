...
//     if (error instanceof ResponseHandledError) {
//       return
//     }
//     console.log(error)
...
//           new ResponseHandledError(statusCode || 408, data, '网络中断'),
//         )
//       }
...
//     return Promise.reject(
//       new ResponseHandledError(
//         code,
//         error.response.data,
//         '请求错误: ' + `[${code}]: Fetch ${error.config.url}`,
//       ),
//     )
//   },
// )

// class ResponseHandledError extends Error {
//   constructor(
